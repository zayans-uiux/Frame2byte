...
export default function PortfolioPage() {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="pt-16 sm:pt-32 pb-12 sm:pb-24 min-h-screen bg-brand-black overflow-x-hidden"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-8 sm:mb-24">
          <motion.h1
            ...
            className="text-4xl sm:text-6xl md:text-8xl font-display font-bold mb-3 sm:mb-6 tracking-tight"
          >
        ...
        <section className="mb-12 sm:mb-32">
          <div className="flex items-center gap-6 mb-6 sm:mb-16 px-2">
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="p-5 sm:p-12 md:p-24 rounded-[1.5rem] sm:rounded-[3rem] glass neon-border text-center relative overflow-hidden shadow-2xl"
        >
          ...
          <h2 className="text-2xl sm:text-4xl md:text-6xl font-display font-bold mb-6 sm:mb-8 tracking-tight">Ready to build something <span className="text-brand-orange">LEGENDARY?</span></h2>
          <p className="text-sm sm:text-base md:text-lg text-white/60 mb-10 sm:mb-12 max-w-2xl mx-auto leading-relaxed font-medium">Join the creators, businesses, and personal brands who are scaling their reach with high-impact, results-driven content strategies.</p>
          <div className="flex justify-center px-2">
            <Link 
              to="/contact#instagram-contact" 
              className="inline-flex items-center justify-center gap-3 w-full sm:w-auto px-6 py-4 sm:px-10 sm:py-5 rounded-2xl sm:rounded-3xl orange-gradient font-bold text-base sm:text-xl hover:scale-105 transition-all shadow-[0_0_40px_rgba(242,125,38,0.4)] active:scale-95"
            >
              LET'S WORK TOGETHER
            </Link>
          </div>
